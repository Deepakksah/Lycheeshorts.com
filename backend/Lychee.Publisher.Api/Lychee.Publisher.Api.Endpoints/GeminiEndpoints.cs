            ...
            var dynamicResult = new
            {
                ...
                scenes = new[]
                {
                    new
                    {
                        ...
                        narration = $"Here is the untold truth about {prompt} that completely changes everything you know.",
                    ...
                    new
                    {
                        ...
                        narration = $"When you look closely at {prompt}, the core principle connects into one clear pattern.",
                    ...
                    new
                    {
                        ...
                        narration = $"Understanding this allows you to apply {prompt} with total confidence and clarity.",
                        captionText = $"TOTAL CONFIDENCE & CLARITY 🚀💡",
